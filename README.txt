Welcome to Searchbox-Suggester!
-----------------------------------

This document explains how the Searchbox-Suggester plugin 
can be configured to provide a Solr search component to add 
out-of-the-box high quality Suggestions to search queries. 

The Searchbox-Suggester plugin analyses the designated full-text fields
